...
return [
    ...
    'resources' => [
        ...
        'payment_methods' => [
            ...
            'helper_text' => [
                'is_primary' => 'Only one payment method should be marked as primary.',
        ...
        'ppob_products' => [
            'model_label' => 'PPOB Product',
            'plural_model_label' => 'PPOB Products',
            'navigation_label' => 'PPOB Products',
            'fields' => [
                'product_name' => 'Product Name',
                'buyer_sku_code' => 'Buyer SKU',
            ...
            'actions' => [
                'sync_prepaid' => 'Sync Prepaid',
                'sync_postpaid' => 'Sync Postpaid',
                'sync_success_title' => 'PPOB sync completed',
                'sync_success_body' => ':count :type products were synchronized.',
            ],
        ],

        'ppob_transactions' => [
            'model_label' => 'PPOB Transaction',
            'plural_model_label' => 'PPOB Transactions',
            'navigation_label' => 'PPOB Transactions',
            'fields' => [
                'product_name' => 'Product',
                'customer_no' => 'Destination / Customer Number',
                ...
                'digiflazz_ref_id' => 'Digiflazz Ref ID',
            ...
            'actions' => [
                ...
                'retry_success_title' => 'PPOB fulfillment dispatched',
                'retry_success_body' => 'Latest fulfillment status: :status.',
                'refresh_status' => 'Refresh Status',
                'refresh_success_title' => 'PPOB status refreshed',
                'refresh_success_body' => 'Latest transaction status: :status.',
            ],
        ],

        'ppob_pricing_rules' => [
            'model_label' => 'PPOB Pricing Rule',
            'plural_model_label' => 'PPOB Pricing Rules',
            'navigation_label' => 'PPOB Pricing',
            'sections' => [
            ...
            'placeholders' => [
                'name' => 'Example: XL prepaid margin',
                'rounding_unit' => 'Example: 100',
                'priority' => 'Lower number wins first',
            ],
            'helper_text' => [
                'matching' => 'Leave all criteria empty to create a global rule.',
                'markup_value' => 'For percent, 2.5 means 2.5%.',
                'rounding_unit' => 'Final sell price is rounded up to this multiple.',
            ],
        ],
    ...
    'widgets' => [
        ...
        'ppob_stats' => [
            'paid_today' => 'PPOB Paid Today',
            'paid_today_description' => 'Value of PPOB transactions paid today',
            'margin_today' => 'Margin Today',
            'margin_today_description' => 'Accumulated markup from PPOB transactions paid today',
            'awaiting_payment' => 'Awaiting Payment',
            'awaiting_payment_description' => 'PPOB transactions that are still unpaid',
            'needs_attention' => 'Needs Attention',
            'needs_attention_description' => 'Paid transactions with non-final fulfillment state',
        ],
    ],
